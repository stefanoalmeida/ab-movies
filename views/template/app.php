...
<?php if (
    ...
    $_SERVER["REQUEST_URI"] == "/cadastrar-filme"
    ) :?>
<header>
    <nav class="w-[1366px] h-[80px] py-[16px] px-[24px] flex items-center justify-between border border-b-[#131320]">
        ...
        <div class="flex items-center gap-[12px]">
            <span class="text-[#B5B6C9] text-[14px]">Olá, Stefano</span>
            <img src="../../assets/img/avatar.png" alt="">
            <img src="../../assets/img/divider.png" alt="">
            <a href="/login" title="Sair" class="w-[32px] h-[32px] flex items-center justify-center border border-[#1A1B2D] rounded-[8px] hover:bg-[#1A1B2D]">
