<main class="py-[64px] px-[88px]">
    <div class="flex items-center justify-between">
        <span class="text-white text-[24px]">Explorar</span>
        <form id="pesquisar" action="" method="post" class="flex items-center gap-[16px]">
    ...
    <div class="flex flex-col items-center gap-[20px] mt-[33px]">
        ...
        <button type="reset" form="pesquisar" class="flex items center gap-[8px] p-[4px] text-[#7A7B9F] text-base cursor-pointer">
            <img src="../assets/img/x-limpar.svg" alt="">
            Limpar filtro
        </button>
    </div>
</main>