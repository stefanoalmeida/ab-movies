    ...
    <div id="login" class="py-[135px] px-[171px]">
        ...
        <div id="form-login" class="flex flex-col items-center">
            ...
            <form action="" method="post" class="flex flex-col gap-[16px]">
                <input type="text" placeholder="Nome" class="w-[328px] py-[12px] px-[16px] rounded-[8px] border border-[#1A1B2D] text-[#7A7B9F] focus: outline-none">
                ...
                <button class="py-[12px] px-[20px] bg-[#892CCD] text-white rounded-[8px] cursor-pointer hover:bg-[#A85FDD]">Criar</button>
            </form>
        </div>
    </div>
</div>
